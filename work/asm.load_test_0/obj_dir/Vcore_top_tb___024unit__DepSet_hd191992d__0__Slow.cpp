...
VL_ATTR_COLD void Vcore_top_tb___024unit___ctor_var_reset(Vcore_top_tb___024unit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vcore_top_tb___024unit___ctor_var_reset\n"); );
