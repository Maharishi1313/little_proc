...
#endif
            VL_FATAL_MT("tb/and_gate_tb.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vand_gate_tb___024root___ctor_var_reset(Vand_gate_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->and_gate_tb__DOT__x = VL_RAND_RESET_I(1);
    vlSelf->and_gate_tb__DOT__y = VL_RAND_RESET_I(1);
    vlSelf->and_gate_tb__DOT__z = VL_RAND_RESET_I(1);
    }
