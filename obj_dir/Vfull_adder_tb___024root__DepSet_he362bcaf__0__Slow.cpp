...
#endif
            VL_FATAL_MT("tb/full_adder_tb.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vfull_adder_tb___024root___ctor_var_reset(Vfull_adder_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->full_adder_tb__DOT__x = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__y = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__cin = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__sum = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__full_adder_inst__DOT__sum_a = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__full_adder_inst__DOT__c_a = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__full_adder_inst__DOT__c_b = VL_RAND_RESET_I(1);
    }
